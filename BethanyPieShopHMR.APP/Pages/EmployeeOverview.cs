...
namespace BethanyPieShopHMR.APP.Pages
{
    public partial class EmployeeOverview //aggiungi partial così quando trova code nel razor puoi aggiungere codice da qui invece che da li
    {
        ...
        protected override Task OnInitializedAsync() //inizializzazione del componente fa queste cose anche se non è la miglior cosa farlo nel costruttore
        {
			InitializeCountries();
            InitializeEmployees();
